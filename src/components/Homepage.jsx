            ...
            <div>
              ...
              <div className="relative w-full">
                <p className="italic text-gray-700 text-lg leading-relaxed mb-6 text-center max-w-2xl mx-auto">
                  The NITCAMP mentorship program provided invaluable career guidance and helped me make informed decisions about my future. The structured approach and genuine alumni support made all the difference.
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <div className="text-left">
                  <p className="font-semibold text-blue-800">Arun Raj</p>
                  <p className="text-sm text-gray-600">B.Tech CSE 2022</p>
                </div>
              </div>
